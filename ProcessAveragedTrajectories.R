...
out_dir <- "out_test/" #"dataset/Stochastic/data_inf_rate_0.00001-0.007/"
out_dir_norm <- "out_test_norm" #"dataset/Stochastic/data_inf_rate_0.00001-0.007_norm/"
